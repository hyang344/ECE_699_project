...
CONFIG.PCW_WDT_WDT_IO.VALUE_SRC {DEFAULT} \
  ...
  connect_bd_intf_net -intf_net axi_interconnect_0_M00_AXI [get_bd_intf_pins axi_interconnect_0/M00_AXI] [get_bd_intf_pins led_count_ip_0/AXI4_Lite]
  ...
  connect_bd_net -net S00_ARESETN_1 [get_bd_pins axi_interconnect_0/M00_ARESETN] [get_bd_pins axi_interconnect_0/S00_ARESETN] [get_bd_pins led_count_ip_0/AXI4_Lite_ARESETN] [get_bd_pins led_count_ip_0/IPCORE_RESETN] [get_bd_pins proc_sys_reset_0/peripheral_aresetn]
  connect_bd_net -net clk_wiz_0_clk_out1 [get_bd_pins axi_interconnect_0/ACLK] [get_bd_pins axi_interconnect_0/M00_ACLK] [get_bd_pins axi_interconnect_0/S00_ACLK] [get_bd_pins clk_wiz_0/clk_out1] [get_bd_pins led_count_ip_0/AXI4_Lite_ACLK] [get_bd_pins led_count_ip_0/IPCORE_CLK] [get_bd_pins proc_sys_reset_0/slowest_sync_clk] [get_bd_pins processing_system7_0/M_AXI_GP0_ACLK]
  ...
  create_bd_addr_seg -range 0x00010000 -offset 0x400D0000 [get_bd_addr_spaces processing_system7_0/Data] [get_bd_addr_segs led_count_ip_0/AXI4_Lite/reg0] SEG_led_count_ip_0_reg0
