...
#
# Generated by Vivado on Sat Mar 24 12:20:36 -0700 2018
...
compile()
{
  ...
  vlogan -work xil_defaultlib $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl" +incdir+"D:/Vivado/2017.4/data/xilinx_vip/include" \
  ...
  vlogan -work smartconnect_v1_0 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl" +incdir+"D:/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/sc_util_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_protocol_checker_v2_0_1 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl" +incdir+"D:/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/3b24/hdl/axi_protocol_checker_v2_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work axi_vip_v1_1_1 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl" +incdir+"D:/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/a16a/hdl/axi_vip_v1_1_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log

  vlogan -work processing_system7_vip_v1_0_3 $vlogan_opts -sverilog +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/ec67/hdl" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/02c8/hdl/verilog" +incdir+"$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl" +incdir+"D:/Vivado/2017.4/data/xilinx_vip/include" \
    "$ref_dir/../../../../hello_world.srcs/sources_1/bd/system/ipshared/1313/hdl/processing_system7_vip_v1_0_vl_rfs.sv" \
  2>&1 | tee -a vlogan.log
