...
execute()
{
  irun $irun_opts \
       ...
       -top xil_defaultlib.design_gpio_led \
       -f run.f \
       -top glbl \
       glbl.v \
       +incdir+"$ref_dir/../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/ec67/hdl" \
       +incdir+"$ref_dir/../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/02c8/hdl/verilog" \
       +incdir+"$ref_dir/../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/1313/hdl" \
       +incdir+"../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/ec67/hdl" \
       +incdir+"../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/02c8/hdl/verilog" \
       +incdir+"../../../../Gpio_LED.srcs/sources_1/bd/design_gpio_led/ipshared/1313/hdl" \
